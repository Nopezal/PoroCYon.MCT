...
namespace PoroCYon.MCT.UI.Interface.Controls
{
    ...
    public abstract class Control : ModableObject, ICloneable<Control>
    {
        ...
        public virtual bool IsVisible
        {
            get
            {
                return (Visibility & MctUI.CurrentVisibility) != 0;
            }
        }
        #endregion
        ...
        {
            MctUI.DrawOutlinedString(sb, font, text, position, foreground, background ?? SecondaryColour, offset, Scale, Rotation, Origin, SpriteEffects, LayerDepth);
        }
