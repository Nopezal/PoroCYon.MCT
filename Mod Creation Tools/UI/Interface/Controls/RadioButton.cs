...
namespace PoroCYon.MCT.UI.Interface.Controls
{
    ...
    public class RadioButton : Checkable
    {
        ...
        public override void Draw(SpriteBatch sb)
        {
            ...
            // top, horizontal
            sb.Draw(MctUI.WhitePixel, BoxPosition, null, Colour, Rotation, Origin,
                new Vector2(charSize.X + 6f, 2f) * Scale, SpriteEffects, LayerDepth);
            // bottom, horizontal
            sb.Draw(MctUI.WhitePixel, BoxPosition + new Vector2(0f, charSize.Y - 4f) * Scale, null, Colour, Rotation, Origin,
            ...
            // right, vertical
            sb.Draw(MctUI.WhitePixel, BoxPosition + new Vector2(charSize.X + 6f, 0f) * Scale, null, Colour, Rotation, Origin,
                new Vector2(2f, charSize.Y - 4f) * Scale, SpriteEffects, LayerDepth);

            if (IsChecked)
                MctUI.DrawOutlinedString(sb, Font, DisplayChar.ToString(), BoxPosition + new Vector2(4f), Colour, null, 1f, Scale, Rotation, Origin, SpriteEffects, LayerDepth);
        }
    }
}
